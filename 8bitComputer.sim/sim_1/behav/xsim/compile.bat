...
REM
REM Generated by Vivado on Sat Aug 01 19:17:56 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj computer_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj computer_tb_vlog.prj -log xvlog.log
